...
import { DeviceHost, Devices } from "@/audio-engine-shared/adapters/devices"
		...
		<div className={className}>
			...
			<div className="manual help-section">
				<section>
					...
					<p>
						To start making sound, click on an instrument from the list. This will create a new instance in your
						project.
					</p>
				</section>
				<section>
