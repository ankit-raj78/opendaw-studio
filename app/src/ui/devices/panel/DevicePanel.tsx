...
export const DevicePanel = ({ lifecycle, service }: Construct) => {
	...
	const noEffectPlaceholder: HTMLElement = (
		<NoEffectPlaceholder lifecycle={lifecycle} service={service} />
	)
	...
	const element: HTMLElement = (
		<div className={className}>
			<div className="devices">
				{devices}
				<Scroller lifecycle={lifecycle} model={scrollModel} floating={true} orientation={Orientation.horizontal} />
			</div>
